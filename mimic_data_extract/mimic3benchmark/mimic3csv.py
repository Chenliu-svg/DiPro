...
def read_events_table_by_row(mimic3_path, table):
    #313645064  118171368  4234968 696093
    nb_rows = {'chartevents': 313645063, 'labevents': 118171367, 'outputevents': 4234967, 'procedureevents':696092}

    # nb_rows = {'chartevents': 329499788, 'labevents': 122103667, 'outputevents': 4457381}
    csv_files = {'chartevents': 'icu/chartevents.csv', 'labevents': 'hosp/labevents.csv', 'outputevents': 'icu/outputevents.csv','procedureevents': 'icu/procedureevents.csv'}
...
def read_events_table_and_break_up_by_subject(mimic3_path, table, output_path,
    ...
    #
    # nb_rows_dict = {'chartevents': 313645063, 'labevents': 118171367, 'outputevents': 4234967, 'procedureevents': 696092}
    nb_rows_dict = {'chartevents': 313645063, 'labevents': 118171367, 'outputevents': 4234967}
